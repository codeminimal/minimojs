...
public class XJS {
    ...
    public static synchronized String getFirstLevelFunctions(String js) throws IOException, ScriptException {
        return exposeFunctions(js, "var append_xmeta = " + components + ";", "X");
    }

    public static synchronized String exposeFunctions(String js, String preScript, String variavel) throws IOException, ScriptException {
        int from = 0;
        ...
        synchronized (engine) {
            ...
            return thisFunctions(variavel, engine.eval("thisFunctions").toString());
        }
    }
            ...
            if (annotation != null) {
                if (annotation.equals(Annotation.service)) {
                    ...
                    xbinds.append("X.import('").append(values[1])
                            .append(".p.js', function(o){o.CTX=X.CTX;" + values[0] + "=o;__chord.notify();});\n");
                    result.append("var ").append(values[0]).append(";\n");
                    countVars++;
                    countImports++;
                    if (values[2] != null) {
